  ...
  return (
    <div>
      <div className="mb-3 flex items-center justify-between">
        ...
        <div className="flex gap-3 text-[10px] text-neutral-500 sm:text-xs">
        ...
        {riwayat.map((r, i) => (
          ...
          >
            <div className="mb-1 flex items-center justify-between">
              <span className="text-[10px] font-medium text-neutral-300">{r.no}</span>
              <span
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-[11px] text-neutral-300">{r.produk}</span>
              </div>
          ...
          <tbody>
            {riwayat.map((r, i) => (
              <tr key={i} className="border-b border-neutral-800">
                <td className="py-2 font-medium text-neutral-300">{r.no}</td>
                <td className="py-2 text-neutral-500">{r.waktu}</td>
